...
inline std::chrono::nanoseconds TSCClock::Now()
{
	return TSCClock::FromCycles(TSCClock::NowInCycles());
}

inline uint64_t TSCClock::NowInCycles()
{
